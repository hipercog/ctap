function strout = cellstr2str(strarray, varargin)
%CELLSTR2STR - Catenate cell array of strings into single string
%
...
%
% Syntax:
%   strout = cellstr2str(strarray, varargin)
%
% Inputs:
...
% References:
%
% Example: strout = cellstr2str({'pla','plop'}, 'sep', ';')
%
% Notes:
%
% See also:
