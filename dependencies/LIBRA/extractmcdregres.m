...
Braw_k = sigmattkmax_k\sigmatykmax_k;
intraw_k = (muykmax_k - (sigmaytkmax_k*(sigmattkmax_k\mutkmax_k)))';
...
Bk = sigmattkmaxrew_k\sigmatykmaxrew_k;
intk = (muykmaxrew_k - (sigmaytkmaxrew_k*(sigmattkmaxrew_k\mutkmaxrew_k)))';% 
rewclasscov=cov(geg(rewweights==1,:));
rewclasscenter=mean(geg(rewweights==1,:));
