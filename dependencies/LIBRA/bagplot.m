...
% vertices of the 2 depth regions. Finally, all the data points are characterized
...
result=struct('tukmed',tukmed,'datatyp',datatyp,'interpol',interpol,'depth',depth);
